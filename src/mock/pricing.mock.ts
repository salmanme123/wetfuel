...
export const mockPricingRules: PricingRule[] = [
  ...
  { id: 'pr-005', tenantId: 'tenant-001', organizationId: 'org-007', name: 'Miami OPIS Diesel', type: 'opis', fuelType: 'diesel', marginType: 'fixed', marginValue: 1.25, minimumPrice: 3.75, isDefault: true, status: 'active', createdAt: '2025-03-01T00:00:00Z', updatedAt: '2026-04-01T00:00:00Z' },
...
export const mockTaxRules: TaxRule[] = [
  ...
  { id: 'tax-004', tenantId: 'tenant-001', organizationId: 'org-007', name: 'Federal Excise Tax - Diesel', taxType: 'federal', fuelType: 'diesel', state: null, rate: 0.244, rateType: 'per_gallon', isActive: true, effectiveDate: '2024-01-01', createdAt: '2024-01-01T00:00:00Z' },
  { id: 'tax-005', tenantId: 'tenant-001', organizationId: 'org-007', name: 'Florida State Fuel Tax', taxType: 'state', fuelType: 'diesel', state: 'FL', rate: 0.36, rateType: 'per_gallon', isActive: true, effectiveDate: '2024-01-01', createdAt: '2024-01-01T00:00:00Z' },
