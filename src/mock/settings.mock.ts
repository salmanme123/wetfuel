...
export const mockAutoAssignmentRules: AutoAssignmentRule[] = [
  ...
  { id: 'aar-004', tenantId: 'tenant-001', organizationId: 'org-005', name: 'Austin Default — Least Loaded', strategy: 'least_loaded', isActive: true, customerId: null, customerName: null, driverId: null, driverName: null, priority: 10, createdAt: '2025-03-01T00:00:00Z' },
